...
const qaChecklist = [
  ...
  {
    title: 'Links & buttons',
    detail: 'Every link works and each book button opens the right Calendly event type.',
  },
...
const launchSteps = [
  'Merge to master',
  'Deploy',
  'Scan the printed QR with multiple phones',
];
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-14 px-4 py-10 sm:py-14 sm:gap-16">
        ...
        <section className="space-y-6 border-t border-border pt-10">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Ship a stable v1 and improve it based on what the real data tells you.
            </p>
