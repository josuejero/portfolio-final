...
interface DieState {
    ...
    projects: Array<{ id: number, name: string, skills: Array<string> }>;
}



function Die({}: DieProps): React.ReactElement<DieState> {
    const skills = ['javascript', 'python', 'react', 'node.js', 'java', 'c#'];
    const [diceValue, setDiceValue] = useState(1);
    const [selectedSkill, setSelectedSkill] = useState('');
    const [projects, setProjects] = useState<Array<{ id: number, name: string, skills: Array<string> }>>([]);
